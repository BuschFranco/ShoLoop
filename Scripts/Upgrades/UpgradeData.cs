...
public class UpgradeData
{
    ...
    private static Dictionary<RewardTier, List<UpgradeData>> BuildFullCatalog() => new()
    {
        [RewardTier.Common] = new List<UpgradeData>
        {
            ...
            new("Velocidad I", "+12 velocidad", UpgradeType.MovementSpeed, RewardTier.Common, 12f, cost: 10),
        ...
        [RewardTier.Epic] = new List<UpgradeData>
        {
            ...
            new("Velocidad III", "+32 velocidad", UpgradeType.MovementSpeed, RewardTier.Epic, 32f, cost: 28),
